...
wget -O /var/volatile/tmp/BoHLALA_FHD.tar.gz --no-check-certificate "https://github.com/BoHLALA/BOHLALA/raw/main/BoHLALA_FHD.tar.gz"
wget -O /var/volatile/tmp/BO_HLALA_skin_V2.2.tar.gz --no-check-certificate "https://github.com/BoHLALA/BOHLALA/raw/main/BO_HLALA_skin_V2.2.tar.gz"
wget -O /var/volatile/tmp/addons1.tar.gz --no-check-certificate "https://github.com/biko-73/BoHLALA/BOHLALA/raw/main/addons1.tar.gz"
wget -O /var/volatile/tmp/addons2.tar.gz --no-check-certificate "https://github.com/biko-73/BoHLALA/BOHLALA/raw/main/addons2.tar.gz"
